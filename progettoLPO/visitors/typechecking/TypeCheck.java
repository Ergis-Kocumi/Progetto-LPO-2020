package progettoLPO.visitors.typechecking;

import static progettoLPO.visitors.typechecking.PrimtType.*;
...
public class TypeCheck implements Visitor<Type> {
	...
	public Type visitForStmt(VarIdent ident, Exp exp, Block forBlock) { 
		Type valIdent = env.lookup(ident);
		INT.checkEqual(valIdent); //maybe
	...
	@Override
	public Type visitSeasonLiteral(String value) { //aggiunto io
		return SEASON;
	}
